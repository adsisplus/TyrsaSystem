...
namespace Adsisplus.Cotyrsa.DataAccess.Context
{
    ...
    partial void OnCreated();
		...
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), intDatosVigaID, intDetCotizaID, sKU, sintPinturaID, intElementoID, intDatoMarcoID, decLargo, intCantidad, bitActivo, tinOpcion);
